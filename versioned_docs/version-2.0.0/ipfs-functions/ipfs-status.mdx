...
* Created <Step text="6"/> : This is a timestamp in ISO 8601 format: YYYY-MM-DDTHH:MM:SSZ for the *CID* creation.
* Pins <Step text="7"/> : Array of structs that holds info for an IPFS Pin.
* Deals <Step text="8"/> : Array of structs that holds info for an IPFS Deal.