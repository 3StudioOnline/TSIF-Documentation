...
IPLD node kind can be *obtained* using the `Get Kind` property getter, that returns an *enum value* <Step text="1"/>
...
* `Node` <Step text="1"/> : IPLD Node Object, the IPLD node that will be checked.
