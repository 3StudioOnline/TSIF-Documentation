...
* `Public Key` <Step text="1"/> : Byte array, public key bytes encoded in the source encoding.
...
* `Private Key` <Step text="1"/> : Byte array, private key bytes encoded in the source encoding.
